...
const { detectShell, getCurrentShell, generateEnvCommands, removeHooks, generateShellFunction, upsertManagedBlock, getAllShellConfigFiles, SHELL_CONFIG_PATHS } = require('./shell');
...
function installHook() {
  ...
  if (!allCandidates || allCandidates.length === 0) {
    ...
    console.error(`Please manually add ${CMD_NAME} function to your shell config`);
    process.exit(1);
  }
